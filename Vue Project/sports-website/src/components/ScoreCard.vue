<template>
    <div class="border border-2 p-3 m-4 bg-light" v-if="this.loaded">
        ...
        <div class="row justify-content-between pt-4 px-5 text-dark">
            ...
            <h6 class="col-sm pt-2 d-none d-md-inline">({{getTeam(this.game.HomeTeam).Wins}}/{{getTeam(this.game.HomeTeam).Losses}}/{{getTeam(this.game.HomeTeam).Ties}})</h6>
        ...
        <div class="row justify-content-between pt-3 pb-4 px-5 text-black">
            ...
            <h6 class="col-sm pt-2 d-none d-md-inline">({{getTeam(this.game.AwayTeam).Wins}}/{{getTeam(this.game.AwayTeam).Losses}}/{{getTeam(this.game.AwayTeam).Ties}})</h6>
        ...
        methods:{
            ...
            getTeam(teamString){
                for(let i=0;i<this.teams.length;i++){
                    if(teamString===this.teams[i].abbrev||teamString===this.teams[i].name)
                        return this.teams[i]
                }
            }
        }
